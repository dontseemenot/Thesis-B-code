...
# Change dataset
title = 'Katana Test on CAP filter 2'
dataset = 'CAP'
specific_dataset = 'CAP_overlap_filter2'
...
model_name = 'AlexNet'
outer_fold_limit = 100    # For debugging purposes; set to > n_outer_split for normal usage
...
if dataset == 'CAP':
    ...
    n_splits = 10
    group_dict = {pID: i % n_splits for i, pID in enumerate(pIDs)}